...
const modelsInfo = {
  ...
  Product: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
...
const outputsInfo = {
  ...
  UserGroupBy: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role", "_count", "_min", "_max"],
  AggregateProduct: ["_count", "_min", "_max"],
  ProductGroupBy: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "userId", "_count", "_min", "_max"],
  AggregateCustomer: ["_count", "_min", "_max"],
  CustomerGroupBy: ["id", "createdAt", "name", "email", "phone", "address", "_count", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  UserCountAggregate: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role", "_all"],
  UserMinAggregate: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  UserMaxAggregate: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  ProductCount: ["uses", "usedIn"],
  ProductCountAggregate: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "userId", "_all"],
  ProductMinAggregate: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
  ProductMaxAggregate: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
  ...
  CreateManyUserAndReturnOutputType: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  CreateManyProductAndReturnOutputType: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "userId"],
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  UserOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  UserWhereUniqueInput: ["id", "userName", "email", "phone", "AND", "OR", "NOT", "createdAt", "updatedAt", "name", "password", "role"],
  UserOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role", "_count", "_max", "_min"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  ProductWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "uses", "usedIn"],
  ProductOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "uses", "usedIn"],
  ProductWhereUniqueInput: ["id", "batch", "AND", "OR", "NOT", "createdAt", "updatedAt", "name", "description", "producedAt", "expiredAt", "uses", "usedIn"],
  ProductOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "_count", "_max", "_min"],
  ProductScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
  ...
  CustomerWhereUniqueInput: ["id", "email", "phone", "AND", "OR", "NOT", "createdAt", "name", "address"],
  CustomerOrderByWithAggregationInput: ["id", "createdAt", "name", "email", "phone", "address", "_count", "_max", "_min"],
  CustomerScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "name", "email", "phone", "address"],
  UserCreateInput: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  UserUpdateInput: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  UserCreateManyInput: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  UserUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  ProductCreateInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "uses", "usedIn"],
  ProductUpdateInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "uses", "usedIn"],
  ProductCreateManyInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
  ProductUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
  ...
  UserCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  UserMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  UserMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "userName", "email", "phone", "password", "role"],
  ...
  ProductCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
  ProductMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
  ProductMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
  ...
  ProductUpdateManyWithoutUsedInNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ProductUpdateManyWithoutUsesNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ProductCreateWithoutUsedInInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "uses"],
  ProductCreateOrConnectWithoutUsedInInput: ["where", "create"],
  ProductCreateWithoutUsesInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "usedIn"],
  ...
  ProductScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt"],
  ...
  ProductUpdateWithoutUsedInInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "uses"],
  ProductUpdateWithoutUsesInput: ["id", "createdAt", "updatedAt", "name", "description", "batch", "producedAt", "expiredAt", "usedIn"]
};
